...
from common.utils import get_datetime_for_history_plex_string, get_tag, get_formatted_emby, get_formatted_plex, build_target_string
...
class DeleteWatched(ServiceBase):
    def __init__(self, ansi_code, plex_api, tautulli_api, emby_api, jellystat_api, config, logger, scheduler):
        ...
        try:
            ...
            for library in config['libraries']:
                ...
                self.libraries.append(LibraryInfo(current_id, plex_library_name, plex_library_id, plex_media_path, 
    ...
    def hours_since_play(self, use_utc_time, play_date_time):

...
class TautulliAPI:
    def __init__(self, url: str, api_key: str, logger: Logger):
        ...
        self.log_header = utils.get_log_header(utils.get_tautulli_ansi_code(), self.__module__)
    ...
    def get_name(self) -> str:
        try:
            ...
            self.logger.error("{} get_server_info {}".format(self.log_header, utils.get_tag('error', e)))
        return self.invalid_item_id
    
    def get_connection_error_log(self) -> str:
        return 'Could not connect to {} {} {}'.format(utils.get_formatted_tautulli(),  utils.get_tag('url', self.url),  utils.get_tag('api_key', self.api_key))
    ...
    def get_library_id(self, lib_name: str) -> str:
        try:
            ...
            self.logger.error("{} get_library_id {} {}".format(self.log_header,  utils.get_tag('library', lib_name),  utils.get_tag('error', e)))
    ...
    def get_user_id(self, user_name: str) -> str:
        ...
        try:
            ...
            self.logger.error("{} get_user_id {} {}".format(self.log_header,  utils.get_tag('user', user_name),  utils.get_tag('error', e)))
    ...
    def get_user_info(self, user_name: str) -> Any:
        ...
        try:
            ...
            self.logger.error("{} get_user_info {} {}".format(self.log_header,  utils.get_tag('user', user_name),  utils.get_tag('error', e)))
    ...
    def get_watch_history_for_user(self, user_id: str, dateTimeStringForHistory: str) -> Any:
        ...
        try:
            ...
            self.logger.error("{} get_watch_history_for_user {} {}".format(self.log_header,  utils.get_tag('user_id', user_id),  utils.get_tag('error', e)))
    ...
    def get_watch_history_for_user_and_library(self, user_id: str, lib_id: str, dateTimeStringForHistory: str) -> Any:
        ...
        try:
            ...
            self.logger.error("{} get_watch_history_for_user_and_library {} {} {}".format(self.log_header,  utils.get_tag('user_id', user_id),  utils.get_tag('library_id', lib_id),  utils.get_tag('error', e)))
    ...
    def get_filename(self, key: Any) -> str:
        try:
            ...
            self.logger.error("{} get_filename {} {}".format(self.log_header,  utils.get_tag('key', key),  utils.get_tag('error', e)))
